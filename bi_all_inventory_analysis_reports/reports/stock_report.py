...
class StockExpiry(models.Model):
    ...
    _description = "Description for StockExpiry"
    ...
    def stock_expiry_report_send(self):
        ...
        if config_setting.report_type == 'all':
            template_id = self.env.ref('bi_all_inventory_analysis_reports.email_template_stock_expired_remainder')
        if config_setting.report_type == 'location':
            template_id = self.env.ref('bi_all_inventory_analysis_reports.email_template_stock_expired_remainder_location')
        if config_setting.report_type == 'warehouse':
            template_id = self.env.ref('bi_all_inventory_analysis_reports.email_template_stock_expired_remainder_warehouse')
        if template_id:
