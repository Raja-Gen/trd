...
class inventory_valuation_product_category_report(models.AbstractModel):
    _name = 'report.bi_all_inventory_analysis_reports.inventory_valuation'
    _description = 'Report bi_all_inventory_analysis_reports.inventory_valuation'

    def _get_report_values(self, docids, data=None):
        data = data if data is not None else {}
        docs = self.env['inventory.valuation.report.wizard'].browse(docids)
        data = {'product_ids': docs.product_ids, 'filter_by': docs.filter_by, 'start_date': docs.start_date, 'end_date': docs.end_date, 'warehouse': docs.warehouse,
                'category': docs.category, 'location_id': docs.location_id, 'company_id': docs.company_id.name, 'display_sum': docs.display_sum, 'currency': docs.company_id.currency_id.name}
        return {
            'doc_model': 'inventory.valuation.report.wizard',
            'data': data,
