...
class ReportInventoryCoverage(models.AbstractModel):
    _name = 'report.bi_all_inventory_analysis_reports.template_report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        for ware in ware_obj_list:
            ...
            ware_list.append(ware_id.name)
        ware_list = ", ".join(ware_list)
        ...
        for each in report_data_list:
            ...
            if picking_obj:
                ...
                for pick in picking_obj:
                    ...
                    if any(product_id.id == pro.product_id.id for pro in pick_moves):
