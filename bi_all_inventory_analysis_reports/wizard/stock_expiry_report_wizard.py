...
class stock_expiry_report_wizard(models.TransientModel):
    ...
    _description ='Description for stock_expiry_report_wizard'
    ...
    def print_expiry_report_pdf(self):
        ...
        return self.env.ref('bi_all_inventory_analysis_reports.report_expiry_print').report_action(self,data=datas)
    ...
    def print_expiry_excel_report(self):
        ...
        export_id = self.env['expiry.report.excel'].create({'excel_file': base64.encodebytes(fp.getvalue()), 'file_name': filename})
        res = {
                'view_mode': 'form',
                'res_id': export_id.id,
...
class stock_expiry_excel(models.TransientModel):
    ...
    _description = "Description for stock_expiry_excel"
