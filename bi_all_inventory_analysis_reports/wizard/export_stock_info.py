...
class ExportStockInfoWiz(models.TransientModel):
    ...
    file = fields.Char('Report File Name')
    ...
    def print_pdf_report(self):
        ...
        return self.env.ref('bi_all_inventory_analysis_reports.action_report_export_stock_information').report_action(self, data=datas)
